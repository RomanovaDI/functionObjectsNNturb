...
{
    defineTypeNameAndDebug(I3GGU, 0);
    addToRunTimeSelectionTable(functionObject, I3GGU, dictionary);
}
}
...
bool Foam::functionObjects::I3GGU::calc()
{
...
Foam::functionObjects::I3GGU::I3GGU
(
    const word& name,
    const Time& runTime,
