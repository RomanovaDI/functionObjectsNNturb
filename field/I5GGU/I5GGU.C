...
{
    defineTypeNameAndDebug(I5GGU, 0);
    addToRunTimeSelectionTable(functionObject, I5GGU, dictionary);
}
}
...
bool Foam::functionObjects::I5GGU::calc()
{
    if (foundObject<volVectorField>(fieldName_))
    {
        ...
        (
            ...
            2*GGU011*GGU101+sqr(GGU110)+2*GGU022*GGU202+sqr(GGU220)+
            2*GGU100*GGU001+sqr(GGU001)+2*GGU122*GGU212+sqr(GGU221)+
            2*GGU200*GGU020+sqr(GGU002)+2*GGU211*GGU121+sqr(GGU112)+
            2*GGU012*GGU102+2*GGU201*GGU021+2*GGU120*GGU210
        );
    }
...
Foam::functionObjects::I5GGU::I5GGU
(
    const word& name,
    const Time& runTime,
