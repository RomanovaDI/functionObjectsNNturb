...
#include "fieldAverageGradsItem.H"

// * * * * * * * * * * * * * * Static Data Members * * * * * * * * * * * * * //

const Foam::word Foam::functionObjects::fieldAverageGradsItem::EXT_MEAN
(
    "Mean"
);


const Foam::word Foam::functionObjects::fieldAverageGradsItem::EXT_PRIME2MEAN
(
    "Prime2Mean"
);
...
const Foam::Enum
<
    Foam::functionObjects::fieldAverageGradsItem::baseType
>
Foam::functionObjects::fieldAverageGradsItem::baseTypeNames_
({
...
const Foam::Enum
<
    Foam::functionObjects::fieldAverageGradsItem::windowType
>
Foam::functionObjects::fieldAverageGradsItem::windowTypeNames_
({
...
Foam::functionObjects::fieldAverageGradsItem::fieldAverageGradsItem()
:
    active_(false),
    fieldName_("unknown"),
    mean_(false),
...
Foam::functionObjects::fieldAverageGradsItem::fieldAverageGradsItem
(
    const fieldAverageGradsItem& faItem
)
:
...
void Foam::functionObjects::fieldAverageGradsItem::addToWindow
(
...
void Foam::functionObjects::fieldAverageGradsItem::evolve(const objectRegistry& obr)
{
    totalIter_++;
...
void Foam::functionObjects::fieldAverageGradsItem::clear
(
...
bool Foam::functionObjects::fieldAverageGradsItem::readState(const dictionary& dict)
{
...
void Foam::functionObjects::fieldAverageGradsItem::writeState
(
    dictionary& dict
) const
{
...
void Foam::functionObjects::fieldAverageGradsItem::operator=
(
    const fieldAverageGradsItem& rhs
)
{
    if (this == &rhs)
    {
