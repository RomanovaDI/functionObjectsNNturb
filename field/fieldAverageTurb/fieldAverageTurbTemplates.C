...
#include "fieldAverageTurbItem.H"
#include "volFields.H"
...
template<class Type>
void Foam::functionObjects::fieldAverageTurb::addMeanFieldType
(
    fieldAverageTurbItem& item
)
{
...
template<class Type>
void Foam::functionObjects::fieldAverageTurb::addMeanField
(
    fieldAverageTurbItem& item
)
{
...
template<class Type>
void Foam::functionObjects::fieldAverageTurb::restoreWindowFieldsType
(
    const fieldAverageTurbItem& item
)
{
    if (restartOnOutput_)
    {
...
template<class Type>
void Foam::functionObjects::fieldAverageTurb::restoreWindowFields
(
    const fieldAverageTurbItem& item
)
{
...
void Foam::functionObjects::fieldAverageTurb::addPrime2MeanFieldType
(
    fieldAverageTurbItem& item
)
{
...
template<class Type1, class Type2>
void Foam::functionObjects::fieldAverageTurb::addPrime2MeanField
(
    fieldAverageTurbItem& item
)
{
...
template<class Type>
void Foam::functionObjects::fieldAverageTurb::storeWindowFieldType
(
    fieldAverageTurbItem& item
)
{
...
template<class Type>
void Foam::functionObjects::fieldAverageTurb::storeWindowFields()
{
    typedef GeometricField<Type, fvPatchField, volMesh> VolFieldType;
    typedef GeometricField<Type, fvsPatchField, surfaceMesh> SurfaceFieldType;
    typedef DimensionedField<Type, polySurfaceGeoMesh> SurfFieldType;

    for (fieldAverageTurbItem& item : faItems_)
    {
...
template<class Type>
void Foam::functionObjects::fieldAverageTurb::calculateMeanFields() const
{
    typedef GeometricField<Type, fvPatchField, volMesh> VolFieldType;
    typedef GeometricField<Type, fvsPatchField, surfaceMesh> SurfaceFieldType;
    typedef DimensionedField<Type, polySurfaceGeoMesh> SurfFieldType;

    for (const fieldAverageTurbItem& item : faItems_)
    {
...
template<class Type1, class Type2>
void Foam::functionObjects::fieldAverageTurb::calculatePrime2MeanFields() const
{
    typedef GeometricField<Type1, fvPatchField, volMesh> VolFieldType1;
    typedef GeometricField<Type1, fvsPatchField, surfaceMesh> SurfaceFieldType1;
    typedef DimensionedField<Type1, polySurfaceGeoMesh> SurfFieldType1;
...
template<class Type1, class Type2>
void Foam::functionObjects::fieldAverageTurb::addMeanSqrToPrime2MeanType
(
    const fieldAverageTurbItem& item
) const
{
...
template<class Type1, class Type2>
void Foam::functionObjects::fieldAverageTurb::addMeanSqrToPrime2Mean() const
{
    typedef GeometricField<Type1, fvPatchField, volMesh> VolFieldType1;
    typedef GeometricField<Type1, fvsPatchField, surfaceMesh> SurfaceFieldType1;
    typedef DimensionedField<Type1, polySurfaceGeoMesh> SurfFieldType1;
...
template<class Type>
void Foam::functionObjects::fieldAverageTurb::writeFieldType
(
...
template<class Type>
void Foam::functionObjects::fieldAverageTurb::writeFields() const
{
    typedef GeometricField<Type, fvPatchField, volMesh> VolFieldType;
    typedef GeometricField<Type, fvsPatchField, surfaceMesh> SurfaceFieldType;
    typedef DimensionedField<Type, polySurfaceGeoMesh> SurfFieldType;
