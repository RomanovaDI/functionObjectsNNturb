...
const Foam::word Foam::functionObjects::fieldAverageTurbItem::EXT_MEAN
(
    "Mean"
);


const Foam::word Foam::functionObjects::fieldAverageTurbItem::EXT_PRIME2MEAN
(
    "Prime2Mean"
);
...
const Foam::Enum
<
    Foam::functionObjects::fieldAverageTurbItem::baseType
>
Foam::functionObjects::fieldAverageTurbItem::baseTypeNames_
({
...
const Foam::Enum
<
    Foam::functionObjects::fieldAverageTurbItem::windowType
>
Foam::functionObjects::fieldAverageTurbItem::windowTypeNames_
({
...
Foam::functionObjects::fieldAverageTurbItem::fieldAverageTurbItem()
:
    active_(false),
    fieldName_("unknown"),
    mean_(false),
...
Foam::functionObjects::fieldAverageTurbItem::fieldAverageTurbItem
(
    const fieldAverageTurbItem& faItem
)
:
...
void Foam::functionObjects::fieldAverageTurbItem::addToWindow
(
...
void Foam::functionObjects::fieldAverageTurbItem::evolve(const objectRegistry& obr)
{
    totalIter_++;
...
void Foam::functionObjects::fieldAverageTurbItem::clear
(
...
bool Foam::functionObjects::fieldAverageTurbItem::readState(const dictionary& dict)
{
...
void Foam::functionObjects::fieldAverageTurbItem::writeState
(
    dictionary& dict
) const
{
...
void Foam::functionObjects::fieldAverageTurbItem::operator=
(
    const fieldAverageTurbItem& rhs
)
{
    if (this == &rhs)
    {
