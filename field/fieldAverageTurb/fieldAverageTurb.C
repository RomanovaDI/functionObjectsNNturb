...
{
    defineTypeNameAndDebug(fieldAverageTurb, 0);
    addToRunTimeSelectionTable(functionObject, fieldAverageTurb, dictionary);
}
}
...
void Foam::functionObjects::fieldAverageTurb::initialize()
{
...
void Foam::functionObjects::fieldAverageTurb::restart()
{
...
void Foam::functionObjects::fieldAverageTurb::calcAverages()
{
    if (!initialised_)
    {
        initialize();
...
void Foam::functionObjects::fieldAverageTurb::writeAverages() const
{
...
void Foam::functionObjects::fieldAverageTurb::writeAveragingProperties()
{
    for (const fieldAverageTurbItem& item : faItems_)
    {
...
void Foam::functionObjects::fieldAverageTurb::readAveragingProperties()
{
...
Foam::functionObjects::fieldAverageTurb::fieldAverageTurb
(
    const word& name,
    const Time& runTime,
...
bool Foam::functionObjects::fieldAverageTurb::read(const dictionary& dict)
{
...
bool Foam::functionObjects::fieldAverageTurb::execute()
{
    calcAverages();
...
bool Foam::functionObjects::fieldAverageTurb::write()
{
    writeAverages();
