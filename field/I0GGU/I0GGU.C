...
{
    defineTypeNameAndDebug(I0GGU, 0);
    addToRunTimeSelectionTable(functionObject, I0GGU, dictionary);
}
}
...
bool Foam::functionObjects::I0GGU::calc()
{
    if (foundObject<volVectorField>(fieldName_))
    {
        ...
        (
            resultName_,
            sqr(GGU000+GGU110+GGU220)+sqr(GGU001+GGU111+GGU221)+sqr(GGU002+GGU112+GGU222)
        );
    }
...
Foam::functionObjects::I0GGU::I0GGU
(
    const word& name,
    const Time& runTime,
